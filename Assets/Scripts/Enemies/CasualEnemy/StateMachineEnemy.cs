...
namespace Assets.Scripts.Enemies.CasualEnemy
{
    public class StateMachineEnemy : MonoBehaviour
    {
        ...
        /// <summary>
        /// D�termine quel personnage l'enemey va aggro
        /// </summary>
        ...
        /// <summary>
        /// Liste de tous les �tats du player (Nom de la classe State / Objet de type State)
        /// </summary>
        ...
        private void CalculAggro()
        {
            ...
            {
                // R�cup�ration des distances entre l'enemy et les players
